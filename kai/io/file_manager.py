"""
File Manager - Kai's Memory on Disk
======================================

LEARNING POINT: File System Operations
-----------------------------------------
Kai needs to read and write files for:
...
class FileManager(Module):
    ...
    (the Kai data directory). It cannot read or write anywhere
    ...
    def __init__(self, event_bus: EventBus, base_dir: str | Path | None = None):
        ...
        # Default to ~/.kai/data for persistent storage
        self.base_dir = Path(base_dir) if base_dir else Path.home() / ".kai" / "data"
    ...
    def _safe_path(self, relative_path: str) -> Path:
        ...
        Example:
            base_dir = /home/user/.kai/data
            "notes/todo.txt"       → /home/user/.kai/data/notes/todo.txt  ✓
            "../../etc/passwd"     → /home/user/.kai/etc/passwd            ✗ BLOCKED
        """
