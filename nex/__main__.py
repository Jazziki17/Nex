...
async def main():
    """
    The main async function that boots up Nex.

    LEARNING POINT: async/await
    ----------------------------
    Nex uses asynchronous programming because it needs to do multiple
    ...
    logger.info("=" * 50)
    logger.info("  Nex AI Assistant - Starting Up")
    logger.info("=" * 50)

    # --- Create the engine (the brain of Nex) ---
    engine = NexEngine()
    ...
    try:
        ...
        logger.info("Nex has shut down. Goodbye.")
