...
class WakeWordDetector:
    """
    Detects when the user says the wake word to activate Nex.
    ...
    def __init__(self, wake_words: list[str] | None = None):
        self.wake_words = [w.lower() for w in (wake_words or ["hey nex", "nex"])]
    ...
    def extract_command(self, text: str) -> str | None:
        ...
        Example:
            "Hey Nex, what time is it?" → "what time is it?"
